...
#define LATITUDE    56.7000
#define LONGITUDE 8.2167
#define TIMEZONE +2
...
#define AdditionalTimezone_2 -2 						// Timezone offest
static char AdditionalTimezone_1_Description[] = "CDT"; // Timezone name to display
static char AdditionalTimezone_2_Description[] = "UTC"; // Timezone name to display
// ----- Additional time zones to display on the top right
